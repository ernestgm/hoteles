 ...
 */
class Version20160329031542 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE comentarios (id INT AUTO_INCREMENT NOT NULL, respuestaid INT DEFAULT NULL, hotelcodigo INT DEFAULT NULL, userid INT DEFAULT NULL, titulo VARCHAR(255) DEFAULT NULL, descripcion VARCHAR(255) DEFAULT NULL, fecha DATE DEFAULT NULL, aprobado TINYINT(1) DEFAULT NULL, INDEX IDX_F54B3FC094CAE363 (respuestaid), INDEX IDX_F54B3FC049DF0FC1 (hotelcodigo), INDEX IDX_F54B3FC0F132696E (userid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE hotel (codigo INT AUTO_INCREMENT NOT NULL, marcaid INT DEFAULT NULL, url VARCHAR(255) NOT NULL, geolocalizacion VARCHAR(255) DEFAULT NULL, INDEX IDX_3535ED9A9D1115E (marcaid), PRIMARY KEY(codigo)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE servicios (id INT AUTO_INCREMENT NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, icono VARCHAR(255) DEFAULT NULL, horario VARCHAR(255) DEFAULT NULL, dias_habiles VARCHAR(255) DEFAULT NULL, principal TINYINT(1) DEFAULT NULL, orden INT DEFAULT NULL, Imagenid INT DEFAULT NULL, INDEX IDX_C07E802FE17AC89C (Imagenid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
